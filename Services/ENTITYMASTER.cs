namespace Data_Logger_1._3.Services
{
    ...
    public class ENTITYMASTER : DbContext
    {
        ...
        public const string CONNECTION_STRING = @"Data Source=C:\Data Logger Central\Depository\LOGS_TEST.db";

        // Override OnConfiguring method to set up connection string
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                // await HandleExceptionAsync(invex, "OnConfiguring(optionsBuilder", "InvalidOperationException");
            }
        }
        ...
        public async Task<bool> SetCurrentUser(ACCOUNT account)
        {
            try
            {
                var user = Accounts.FirstOrDefault(a => a.accountID == account.accountID);
        ...
        /// </summary>
        /// <param name="account">The account to set offline.</param>
